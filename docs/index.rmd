...
plot(rep(0,ncol(umsy_matr))~colnames(umsy_matr),ylim=c(-1,1),ylab='Sustainable harvest rate (Umsy)',type='n',bty='l',xlab='Brood cohort year',xaxt='n')
axis(side=1,at=seq(1950,2020,by=5))
...
lines(m.prod.5f[,1]~seq(min(x),max(x)),lwd=2,col=basin_cols[2])
for(i in 1:nrow(coh_alpha_bsu)){
  lines(coh_alpha_bsu[i,]~colnames(coh_alpha_bsu),col=adjustcolor(basin_cols[3],alpha.f=0.3))
}
m.prod.5f=move_avg_mat(coh_alpha_bsu);m.prod.5f$y=colnames(coh_alpha)[1:c(ncol(coh_alpha)-2)]
m.prod.5f=m.prod.5f[complete.cases(m.prod.5f[,1]),]
x<- c(seq(m.prod.5f$y[1],m.prod.5f$y[nrow(m.prod.5f)]), rev(seq(m.prod.5f$y[1],m.prod.5f$y[nrow(m.prod.5f)])))
y<- c(m.prod.5f[,1]-2*m.prod.5f[,2], rev(m.prod.5f[,1]+2*m.prod.5f[,2]))
polygon(x, y, col = adjustcolor(basin_cols[3], alpha = 0.3), border=NA)
...
lines(m.prod.5f[,1]~seq(min(x),max(x)),lwd=2,col=basin_cols[2])
for(i in 1:nrow(coh_alpha_bs)){
  lines(coh_alpha_bs2[i,]~colnames(coh_alpha),col=adjustcolor(basin_cols[3],alpha.f=0.3))
}
m.prod.5f=move_avg_mat(coh_alpha_bs2u);m.prod.5f$y=colnames(coh_alpha)[1:c(ncol(coh_alpha)-2)]
m.prod.5f=m.prod.5f[complete.cases(m.prod.5f[,1]),]
x<- c(seq(m.prod.5f$y[1],m.prod.5f$y[nrow(m.prod.5f)]), rev(seq(m.prod.5f$y[1],m.prod.5f$y[nrow(m.prod.5f)])))
y<- c(m.prod.5f[,1]-2*m.prod.5f[,2], rev(m.prod.5f[,1]+2*m.prod.5f[,2]))
polygon(x, y, col = adjustcolor(basin_cols[2], alpha = 0.3), border=NA)
...
plot(rep(0,ncol(soc_alpha))~colnames(soc_alpha),ylim=c(0,25),ylab='Max. recruits/spawner',type='n',bty='l',xlab='Brood cohort year',xaxt='n')
axis(side=1,at=seq(1950,2020,by=5))
for(i in 1:nrow(soc_alpha_orwa)){
  lines(exp(soc_alpha_orwa)[i,]~colnames(soc_alpha),col=adjustcolor(basin_cols[1],alpha.f=0.3))
}
...
axis(side=1,at=seq(1950,2020,by=5))
for(i in 1:nrow(soc_alpha_orwa)){
  lines(soc_alpha_orwa2[i,]~colnames(soc_alpha),col=adjustcolor(basin_cols[1],alpha.f=0.3))
}
m.prod.5f=move_avg_mat(soc_alpha_orwa2);m.prod.5f$y=colnames(soc_alpha)[1:c(ncol(soc_alpha)-2)]
m.prod.5f=m.prod.5f[complete.cases(m.prod.5f[,1]),]
x<- c(seq(m.prod.5f$y[1],m.prod.5f$y[nrow(m.prod.5f)]), rev(seq(m.prod.5f$y[1],m.prod.5f$y[nrow(m.prod.5f)])))
y<- c(m.prod.5f[,1]-2*m.prod.5f[,2], rev(m.prod.5f[,1]+2*m.prod.5f[,2]))
polygon(x, y, col = adjustcolor(basin_cols[1], alpha = 0.3), border=NA)
...
axis(side=1,at=seq(1950,2020,by=5))
for(i in 1:nrow(soc_alpha_orwa)){
  lines(soc_alpha_orwau[i,]~colnames(soc_alpha),col=adjustcolor(basin_cols[1],alpha.f=0.3))
}
m.prod.5f=move_avg_mat(soc_alpha_orwau);m.prod.5f$y=colnames(soc_alpha)[1:c(ncol(soc_alpha)-2)]
m.prod.5f=m.prod.5f[complete.cases(m.prod.5f[,1]),]
x<- c(seq(m.prod.5f$y[1],m.prod.5f$y[nrow(m.prod.5f)]), rev(seq(m.prod.5f$y[1],m.prod.5f$y[nrow(m.prod.5f)])))
y<- c(m.prod.5f[,1]-2*m.prod.5f[,2], rev(m.prod.5f[,1]+2*m.prod.5f[,2]))
polygon(x, y, col = adjustcolor(basin_cols[1], alpha = 0.3), border=NA)
...
plot(rep(0,ncol(soc_alpha))~colnames(soc_alpha),ylim=c(-1,1),ylab='Deviations from median Umsy',type='n',bty='l',xlab='Brood cohort year',xaxt='n')
axis(side=1,at=seq(1950,2020,by=5))
for(i in 1:nrow(soc_alpha_orwa2u)){
  lines(soc_alpha_orwa2u[i,]~colnames(soc_alpha),col=adjustcolor(basin_cols[1],alpha.f=0.3))
}
m.prod.5f=move_avg_mat(soc_alpha_orwa2u);m.prod.5f$y=colnames(soc_alpha)[1:c(ncol(soc_alpha)-2)]
m.prod.5f=m.prod.5f[complete.cases(m.prod.5f[,1]),]
x<- c(seq(m.prod.5f$y[1],m.prod.5f$y[nrow(m.prod.5f)]), rev(seq(m.prod.5f$y[1],m.prod.5f$y[nrow(m.prod.5f)])))
y<- c(m.prod.5f[,1]-2*m.prod.5f[,2], rev(m.prod.5f[,1]+2*m.prod.5f[,2]))
polygon(x, y, col = adjustcolor(basin_cols[1], alpha = 0.3), border=NA)
