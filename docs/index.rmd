...
In this section, we estimate the net mean productivity change from the last 5 brood cohort relative to the long-term average productivity (estimated in model 1).
...
```{r, umsy change chk,fig.height=7,fig.width=16,warning= FALSE}
...
```{r, umsy change scy,fig.height=7,fig.width=16,warning= FALSE}
...
```{r, umsy change chm,fig.height=7,fig.width=16,warning= FALSE}
...
```{r, umsy change cho,fig.height=7,fig.width=16,warning= FALSE}
...
```{r, umsy change pke,fig.height=7,fig.width=16,warning= FALSE}
...
```{r, umsy change pko,fig.height=7,fig.width=16,warning= FALSE}
